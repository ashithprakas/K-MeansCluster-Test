...
class RegularKMeansUI(BaseClusteringUI):
    def __init__(self, root):
        super().__init__(root, title="Regular K-Means Clustering UI", mode="regular")
    ...
    def update_plot(self):
        try:
            ...
            self.ax.set_title(f'Regular K-Means Clustering (K={k})')
